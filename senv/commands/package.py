...
from senv.commands.settings_writer import remove_config_value_from_path
...
def build_package(
    ...
    if build_system == BuildSystem.POETRY:
        ...
        with tmp_env(), tmp_repo() as tmp_dir:
            ...
            pyproject_to_recipe_yaml(
                python_version=python_version, output=meta_path, source_path=tmp_dir
            )
            if python_version:
